(() => {
	...
	class i extends e.EventEmitter {
		constructor(t = __uv$config) {
			super(), t.bare || (t.bare = localStorage.getItem("bare")), t.prefix || (t.prefix = "/service/"), this.config = t;
		...
		async fetch({
			...
			try {
				...
				d.headers["user-agent"] = localStorage.getItem("ua"), u && (d.headers.cookie = u);
